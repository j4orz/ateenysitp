...
- [**4. Learning *Sequences* from Data with Autoregressive Deep Neural Networks in `torch`**](#4-learning-sequences-from-data-with-deep-neural-networks-in-torch)
  - [4.1 From Supervised to Self-Supervised Learning]()
  - [**4.2 Learning Sequences with Linear Models**](#42-learning-sequences-with-linear-models)
  - [4.3 From Linear to Non-Linear Learning]()
  - [4.4 Learning Sequences with Feedforward Neural Networks]() <!-- [4.3 Learning Embeddings with Feedforward Neural Networks]() -->
...
- [**5. Accelerating *Sequence Models* on `GPU` in `teenygrad`**](#5-accelerating-sequence-models-on-gpu-in-teenygrad-with-cuda-rust)
  ...
  - [**5.4 From `SIMD` to `SIMT`: From Multi Core to Many Core Processors**](#54-from-simd-of-multi-core-latency-oriented-processors-to-simt-of-many-core-throughput-oriented-processors)
  - [**5.5 Accelerating `GEMV` on `GPU` with `CUDA Rust` and `PTX` via Rooflines**](#55-accelerating-gemv-on-gpu-with-cuda-rust-and-ptx-via-rooflines)
