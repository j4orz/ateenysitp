...
- [1. Sequence Learning](#1-sequence-learning)
  ...
  - [1.2 Language as a Probability Space](#12-language-as-a-probability-space)
...
### 1.2 Language as a Probability Space 
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
Consider the senseless yet grammatical sentence "Colorless green ideas sleep furiously",
and feed it into GPT2 with the word furiously missing. When you click the predict button,
GPT2 produces a list of real numbers represented by floating points
that are between 0 and 1 and sum (or normalize) to 1.
Each number represents
the <span class="defnote">**chance**</span>**chance**, <span class="defnote">**likelihood**</span>**likelihood**, or <span class="defnote">**belief**</span>**belief**
GPT2 has of the next word. But rather than
...
The size of GPT2's vocabulary is 50257, and the list of probabilities you see
...
When you ask an LLM a question, it produces a full answer (with many sentences containing many words
 word by word by repeating the following loop:

1. evaluating the probability of the next word
2. selecting (or sampling) such word
...
such a distribution is a <span class="defnote">**conditional probability**</span>**conditional probability**
distribution. That is, GPT2 is producing the distribution of the next word given, or conditioned on,
the sequence of words passed in as input, and is denoted by

$p(w\underbrace{|}_{\text{given}}\text{input sentence})$

and in the example above, GPT2 is producing $p(w|\text{Colorless green ideas sleep})$.
Now the trillion dollar question, how do you implement such a function $p(\circ)$?
