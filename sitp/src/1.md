...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  ...
  - [1.3 Composing Probabilities with Sums, Products, and Conditionals](#13-composing-probabilities-with-sums-products-and-conditionals)
...
Regular expressions are implemented by the standard libraries of various languages such as Python, Perl, and Java
are highly specialized domain specific languages, namely, the domain of matching text.
Conceived as notation by Stephen Kleene to formally define the class of **regular languages**,
