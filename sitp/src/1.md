...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  - [1.1 From Logical Software 1.0 to Stochastic Software 2.0](#11-from-logical-software-10-to-stochastic-software-20)
...
- [Intermezzo One: The Language of Probability Theory]()
...
- [Intermezzo Two: The Language of Matrix Calculus]()
...
#### 1.1.2 Syntactic Pattern Matching with ELIZA
...
#### 1.1.4 An Attempt at Common Sense with CYC
...
#### 1.1.5 The Bitter Lesson: From Tractatus to Investigations
...
#### 1.1.6 Next Token Prediction As Massively Multi-Task Learning
