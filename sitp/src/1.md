...
- [0. From Logical Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.2 Syntactic Taus with Pattern Matching of `ELIZA`]()
  - [0.3 Narrow Expertise with Logical Semantics of `LUNAR` and `SHRDLU`]()
  - [0.4 An Attempt At General Common Sense with `CYC`]()
