...
a software 2.0 programming language centered around the data structure of the multidimensional array known as `torch.Tensor`, humbly embedded within a Python package.
...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  ...
  - [1.2 Intermezzo One: The Language of Set Theory]()
  - [1.3 Distributing Data *Stochastically* with Probabilities]()
  - [1.4 Composing Probabilities with Sums, Products, and Conditionals]()
  - [1.5 Random Variables with their Distributions, Expectations, and Variance]()
  - [1.6 Learning Probabilities from Data by Counting]()
  - [1.7 Learning Probabilities from Data by Parameter Estimation]()
  - [1.8 Intermezzo Two. The Language of Probability Theory]()
...
- [2. Semi-Automated Semantic Sequence Learning via Linear Models with `teenygrad`]()
  ...
  - [2.2 Intermezzo Three: The Language of Linear Algebra]()
  - [2.3 Predicting Scalars by Linearly Modeling Regression]() <!-- $f: \reals^d \to \reals$ -->
  - [2.4 Directly Fitting Linear Regression with Squared Error Loss]() <!-- $\mathscr{L(\theta)} := $ -->
  ...
  - [2.8 Intermezzo Four: The Language of Calculus]()
...
Although such a simple question, it is indeed quite profound, as it was proposed by Alan Turing in his paper [**Computing Machinery and Intelligence (Turing 1950)**](https://www.cs.mcgill.ca/~dprecup/courses/AI/Materials/turing1950.pdf) to operationalize intelligence, seminating the field of artificial intelligence four years before his passing,
and started proper in 1956 at the [**Dartmouth Workshop (1956)**]().
...
This vision was proposed shortly after the Dartmouth workshop where John McCarthy outlined in his paper [**Programs with Common Sense (McCarthy 1956)**](https://www-formal.stanford.edu/jmc/mcc59.pdf) a hypothetical advice taker program that could (todo) by replicating the human faculty for knowledge aquisition through *symbolic representations* and *logical reasoning*, respectively known as the <span class="defnote">**symbolist**</span>**symbolist** and <span class="defnote">**logicist**</span>**logicist** schools of thought,
which was further eleborated on by Marvin Minsky in his 1974 paper [**A Framework for Representing Knowledge (Minsky 1974)**](https://courses.media.mit.edu/2004spring/mas966/Minsky%201974%20Framework%20for%20knowledge.pdf).
...
#### The Universal Grammar of ELIZA
...
#### The Symbolic Species of WordNet, CYC, and ConceptNet
