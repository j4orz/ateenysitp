...
- [1. Syntactic Sequence Learning](#1-syntactic-sequence-learning)
  ...
  - [1.9 Problems]()
- [Intermezzo One: The Language of Probability and Matrix Calculus](#intermezzo-two-the-language-of-probability-and-matrix-calculus)
...
$$
\begin{aligned}
A &:= \text{it will rain today} \\
B &:= \text{the roof will leak}
\end{aligned}
$$
