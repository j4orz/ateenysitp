...
Before we dive into the internals of [`teenygrad`](https://github.com/j4orz/ateenysitp) itself in [Chapter 2. The Tensor](#2-from-ipls-array-to-apls-multidimensional-array) and implement our own framework capable of training the bigram and logistic regression models,
...
please consult [Appendix A. From Problems to Proof](./ap.md#a-from-problems-to-proof).
The one text which was heavily consulted over others was [Formal Aspects to Language Modelling (x, y, z, Cotterell 2024)]().
