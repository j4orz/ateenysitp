...
However, the programmer interested in learning the skills required for the deep learning approach to artificial intelligence
...
*software 2.0*<span class="sidenote-number"></span><span class="sidenote">*[A term coined by Andrej Karpathy in 2017](https://karpathy.medium.com/software-2-0-a64152b37c35)*</span>, a distinction coined by Andrej Karpathy in 2017 to differentiate the classical programming of writing software line by line, and the newer approach which is specifying a dataset, a neural net architecture with a goal, and searching the space of programs with compute.
...
a software 2.0 programming language centered around the data structure of the multidimensional array known as `torch.Tensor`, humbly embedded in within a Python package.
...
**SITP** has been meticulously designed and engineered
...
Ever since humans have harnessed the ability to orchestrate electrons with transistors, programming language implementors
have been on a continuous pursuit to increase the level of abstraction of these programming languages
— although we've been able to transition from machine languages, to assembly languages, to system languages, and finally to high level languages, something was always missing.

For instance, even though the Python programming language is very English-like, beneath the veneer of pseudocode is a formal language that is rigid, sharp, and precise, allowing for mechanical specification.
...
Although such a simple question, it is indeed quite profound, as it was proposed by Alan Turing in his 1950 paper [**Computing Machinery and Intelligence**](https://www.cs.mcgill.ca/~dprecup/courses/AI/Materials/turing1950.pdf) to operationalize intelligence, seminating the field of artificial intelligence four years before his passing,
and started proper in 1956 at the [**Dartmouth Workshop**]().

Although Turing's paper describes (todo: machine learning), the initial approach early pioneers took to build intelligent machinery that could
understand and produce the natural language thus passing Turing's test was in fact quite similar to the art of programming which you already know.
That is, many early systems used the same discrete structures (sets, lists, trees, graphs, associations) and deterministic logic (assignment, control flow, functions)
that <span class="defnote">**software 1.0**</span>**software 1.0** uses to program industrial applications.

While it may be obvious in hindsight from today's vantage point where deep neural networks power most intelligence that this is in fact the incorrect approach,
on an a priori basis, the human faculty for the aquisition of *knowledge* and *reasoning* is one of the primary capabilities that separates us from the rest of the animal kingdom.
This vision was proposed shortly after the Dartmouth workshop where John McCarthy outlined in his 1956 paper [**Programs with Common Sense**](https://www-formal.stanford.edu/jmc/mcc59.pdf) a hypothetical advice taker program that could (todo) by replicating the human faculty for knowledge aquisition through *symbolic representations* and *logical reasoning*, respectively known as the <span class="defnote">**symbolist**</span>**symbolist** and <span class="defnote">**logicist**</span>**logicist** schools of thought,
which was further eleborated on by Marvin Minsky in his 1974 paper [**A Framework for Representing Knowledge**](https://courses.media.mit.edu/2004spring/mas966/Minsky%201974%20Framework%20for%20knowledge.pdf).
To distinguish this approach from the field's probabilistic methods of deep neural networks today, such systems are referred to as <span class="defnote">**GOFAI**</span>**good old fashioned AI**.

(todo: newell and simon. logic theorist..general problem solver..)

One of the earliest and simplest examples of the GOFAI approach to artificial intelligence was **ELIZA**, a computer chatbot implemented in 1966 which simulates a Rogerian psychotherapist conducting person-centered therapy. Systems like ELIZA which followed GOFAI's approach ran into limitations, ultimately predicted by the philosopher Ludwig Wittgenstein even before the Dartmouth project took place in his 1953 book [**Philosophical Investigations**](https://static1.squarespace.com/static/54889e73e4b0a2c1f9891289/t/564b61a4e4b04eca59c4d232/1447780772744/Ludwig.Wittgenstein.-.Philosophical.Investigations.pdf) — namely, that of **describing a reality with too many parts to count**. This is precisely what the <span class="defnote">**connectionist**</span>**connectionist** school of thought solves, and the brain child of such tradition is none other than **ChatGPT**.
...
But before delving into the continuous structures (scalars, vectors, matrices, tensors) and stochastic descriptions (probabilities, random variables, and distributions)
of <span class="defnote">**software 2.0**</span> **software 2.0**, let's review the symbolic and logical methods of GOFAI that were used in systems like ELIZA, and it's GOFAI successors.



---

#### The Non-Universal Grammar of GOFAI
...
perhaps to build a system like ChatGPT all we need to do the same is increase the expressivity of the data structures and algorithms
used for word **representations** and **reasoning**, respectively.
That is, perhaps we should find more expressive representations so that the meaning of life is not simply `"LIFE"`
and subsequent reasoning methods beyond simple if then rules.

---

#### Knowledge Engineering of Expert Systems

todo: after fri/sat/sun, do another pass on previous section
with GOFAI rules, leaving tones of propositional and first order logic
rather than "LIFE", follow SEP..
