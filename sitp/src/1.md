...
which covers early systems from classical computational linguistics and natural language processing. Namely, `ELIZA`, `LUNAR`, and `CYC`. <br><br> Up ahead we will be intuitively introducing many notions from probability and linear algebra in the context of large language modelling with `numpy`. At any time — whether before, in between, or after — you find yourself interested in the formal definitions of such concepts, you can encouraged to visit [§Intermezzo One: The Language of Probability and Linear Algebra](#intermezzo-one-the-language-of-probability-theory-and-linear-algebra). <br style="clear: both;">
...
enabling the representation of <span class="defnote">**scalars**</span>**scalars**, <span class="defnote">**vectors**</span>**vectors**, <span class="defnote">**matrices**</span>**matrices**, and arbitrary <span class="defnote">**tensors**</span>**tensors** of arbitrary rank.
...
> [!QUESTION]
> <img class="owl" src="./assets/owl.png" alt="" style="float: left; width: 100px; margin: 0 1em 0.5em 0;"> Given that you know $p(w|\mathbf{h}) \in \reals^{|V|}$, what do you expect the types of the two distributions $p(w_{t+1}, w_1, w_2, \dots, w_t)$ and $p(w_1, w_2, \dots, w_t)$ to be? How would you implement that in Python with `numpy`? Prompt a language model to implement what you think.  Pause, think and prompt! <br style="clear: both;">
