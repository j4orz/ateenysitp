...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  - [1.1 From Logical Software 1.0 to Stochastic Software 2.0](#11-from-software-10-logical-agents-to-software-20-probabilistic-agents)
  - [1.2 Intermezzo One: The Language of Dependent Type Theory](#12-intermezzo-one-the-language-of-dependent-type-theory)
  - [1.3 From Certain to Uncertain Knowledge with Probabilities]()
...
- [2. Semi-Automated Semantic Sequence Learning via Linear Models with `teenygrad`]()
  ...
  - [2.8 Empirical Risk Minimization is Maximum Likehood Estimation]() <!-- generalized linear models -->
...
### 1.1 From Logical Software 1.0 to Stochastic Software 2.0
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
#### The Model-Based Reflexive Agent SHRDLU
...
### 1.2 Intermezzo One: The Language of Dependent Type Theory
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
