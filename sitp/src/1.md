...
- [1. Syntactic Sequence Learning with n-gram Models](#1-syntactic-sequence-learning-with-n-gram-models)
  ...
  - [1.2 Random Variables and their Distributions]() <!-- Expectations, and Variance -->
  - [1.3 From Evaluating to Recovering Probabilities]() <!-- Statistics -->
  - [1.4 Summary]()
...
(INSERT NGRAM EXAMPLE)

### 1.2 Random Variables and their Distributions
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>

### 1.3 Analytical Probabilities from Data by Counting
```python
...
### 1.4 Learning Probabilities from Data by Parameter Estimation
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
