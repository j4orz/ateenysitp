...
- [1. Syntactic Sequence Learning](#1-syntactic-sequence-learning)
  ...
  - [1.2 Language as a Probability Space of Token Sequences](#12-language-as-a-probability-space-of-token-sequences)
...
### 1.2 Language as a Probability Space of Token Sequences
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
For instance, taking the vocabulary to be $V:= \{\text{colorless}, \text{furiously}, \text{green}, \text{ideas}, \text{sleep} \}$ and $m:=5$,
