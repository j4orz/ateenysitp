...
Although separated by over 2000 years, the programmers of Silicon Valley are facing
the same daunting task that the mathematicians of Ancient Greece have encountered,
which includes both mathematicians who work on logic and programmers who work on programming languages themselves.

To continue contributing towards the civilizational progress of augmenting and amplifying human intelligence,
...
and grappled with the infinite when discovering (or inventing; choose your poison) the real numbers such as $\sqrt{2}$, $\pi$, and $e$.
...
Know that others have made the same trek.<br>
Do not think too much. Just do.<br>
Go now.<br>
...
As what tends to happen, the dichotomy is moreso a fuzzy spectrum, and their relationship is closer to fighting siblings or rivals borrowing ideas from one another. 
Two related tensions which we will explore and transition throughout the book but specifically in [Part I. Elements of Networks]()
