...
- [0. From Symbolic Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.4 Lenat's General Common Sense with the Frames of `CYC`](#04-lenats-general-advice-taker-with-the-frames-of-cyc)
...
def generate(abstract_syntax: str) -> str:
  raise NotImplementedError("")
```
...
Again, following the Design Recipe, let's start with examples:
...
### 0.3.1 `parse()`: From Natural Language as Source to Formal Logic as IR
...
### 0.3.2 `generate():` From Formal Logic as IR to Formal Queries as Target

### 0.3.3 `lunar():` From Natural Language as Source to Formal Queries as Target
...
> it will always be limited to the chemical analysis data in it's knowledge base.
...
- the other reaction is lenat with `CYC`.
...
### 0.4 Lenat's General Advice Taker with the Frames of `CYC`
