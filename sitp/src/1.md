...
- [1. Sequence Learning](#1-sequence-learning)
  ...
  - [1.9 Problems]()
- [Intermezzo One: The Language of Logic, Sets, and Functions](#overture-the-language-of-logic-sets-and-functions)
- [Intermezzo Two: The Language of Probability and Matrix Calculus](#intermezzo-one-the-language-of-probability-and-matrix-calculus)
...
we will only formally construct concepts in Intermezzo chapters *after* intuitively using or implementing such concept with
the `teenygrad` deep learning framework.
