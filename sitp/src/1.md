...
- [*Intermezzo One: The Language of Sets and Logic*](#intermezzo-one-the-language-of-dependent-type-theory)
- [1. Syntactic Sequence Learning](#1-syntactic-sequence-learning)
  ...
  - [1.4 Linearly Modeling Classification]() <!-- $f: \reals^d \to \N$ -->
  ...
  - [1.9 Problems]()
- [*Intermezzo Two: The Language of Stochastics and Matrix Calculus*]()
- [2. From IPL's Array to APL's Multidimensional Array](#3-from-abstract-to-numerical-linear-algebra)
  - [2.1 From Virtual to Physical Machines (and Shapes)](#31-from-virtual-to-physical-machines) <!-- three language problem: rust translation and risc-v evaluation -->
...
### 1.4 Predicting Categories by Linearly Modeling Classification <!-- $f: \reals^d \to \N$ -->
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
