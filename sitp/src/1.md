...
- [0. From Symbolic Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.3 Wood's Natural Language Understanding with the Syntax and Semantics of `LUNAR`](#03-woods-natural-language-understanding-with-the-syntax-and-semantics-of-lunar)
...
> In which we retrace the development and failure of the discretely symbolic approach to build artificially intelligent machines with common sense and motivate the need to transition from logically discrete software 1.0 to stochastically continuous software 2.0.
...
What do we mean by such high fallutin gibberish gook?
...
from the *observationally simple* like stimulus-response to the *constructively complex* such as neural networks.
<span class="sidenote-number"></span><span class="sidenote">*Practical applications are usually a result of inquiry which is usually philosophical, esoteric, and with no immediately economic value. Namely, computers with automating mathematics, and language models with mechanizing the mind, even if neural networks do not sufficiently model human intelligence.*</span>
...
using the computer also means something quite profound.
...
These systems by nature are *stochastically continuous* software 2.0 rather than the *logically discrete* software 1.0
and are implemented not by programming algorithms and their procedures line by line with sets, maps, trees, and graphs,
...
understanding the underlying philosophical principle, and ultimately motivating the need for software 2.0.
...
### 0.3 Wood's Natural Language Understanding with the Syntax and Semantics of `LUNAR`
