...
- [0. From Symbolic Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.4 Lenat's Advice Taker with the Frames of `CYC`](#04-lenats-advice-taker-with-the-frames-of-cyc)
...
This clearly does not scale, for in the case where our patient prompts `eliza` with case not handled,
for instance, that they are upset, our implementation immediately fails:
...
For instance, in the case where a patient's prompt takes the <span class="defnote">**syntax**</span>**structural form** "I am BLAH",
`eliza` can respond with "Why do you say you are BLAH?" independent of BLAH's <span class="defnote">**semantics**</span>**meaning**.
...
This is where we need to to use some formal language theory, which models a <span class="defnote">**language**</span>**language** *as* a set of strings,
...
The core interest of such theory is to determine whether a given string is in a language or not,
known as the <span class="defnote">**membership problem**</span>**membership problem**.

In our case, we'd like to somehow define the language of all strings that take the form "I am BLAH",
and then match all strings that are inside that set. How do we characterize such set?
We can do so with a <span class="defnote">**regular expression**</span>**regular expression**,
which defines the <span class="defnote defnote-stack">**regular language**</span>**regular language** of said strings, "I am BLAH'.
...
Particularly with Python, regular expressions are available via standard library's [`re`](https://docs.python.org/3/library/re.html) module with a two step process.
...
In our case where we'd like to characterize all strings that take the form "I am BLAH", we need to use the Kleene star effectively acting as wildcard:
...
As an escape hatch for `eliza()`'s utter lack of semantic understanding with word meaning,
...
does, building a natural language interface with a database containing chemical analysis data on lunar rock and soil from the from the Apollo 11 moon missions
...
called <span class="defnote">**parsing**</span>**parsing** and <span class="defnote defnote-stack">**generation**</span>**generation**
...
let's implement their implementations to support new language features on an incremental-basis.

#### 0.3.2 A Linguistic Parser
...
a more <span class="defnote defnote-stack">**abstract syntax**</span>**abstract** data structure that has more "understanding" of what's being spoken to it compared to a simple silly `str`. Because this abstract representation of the program is not the final representation (namely x86), it's referred to as the <span 
...
a <span class="defnote">**regular language**</span>**regular language** are defined by context-free grammar
loremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsum
a <span class="defnote">**regular expression**</span>**regular expression** are defined by context-free grammar
loremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsum
a <span class="defnote defnote-stack">**syntactic grammar**</span>**syntactic grammar** are defined by context-free grammar
loremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsum
a <span class="defnote defnote-stack">**context-free language**</span>**context-free language** are defined by context-free grammar
loremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsum
