...
- [1. Sequence Learning](#1-sequence-learning)
  ...
  - [1.2 Estimation by Counting of Bigrams](#12-estimation-with-counting-bigrams)
  - [1.3 Parameterization by Fitting Logistic Regression](#13-parameterization-by-fitting-logistic-regression) <!-- logistic reg/1 layer ffn -->
  - [1.4 Lagniappe: Fitting Linear Regression](#14-Lagniappe-fitting-linear-regression) <!-- with least squared error -->
