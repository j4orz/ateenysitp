...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  ...
  - [1.2 Intermezzo One: The Language of Set Theory and Logic](#12-intermezzo-one-the-language-of-set-theory-and-logic)
  - [1.3 From Certain to Uncertain Knowledge by Distributing Truth with Probabilities]()
  ...
  - [1.6 Analytical Probabilities from Data by Counting](#16-analytical-probabilities-from-data-by-counting)
  - [1.7 Learning Probabilities from Data by Parameter Estimation]()
  - [1.8 Intermezzo Two: The Language of Probability Theory](#18-intermezzo-one-the-language-of-probability-theory)
...
- [2. Semi-Automated Semantic Sequence Learning via Linear Models with `teenygrad`]()
  ...
  - [2.8 Intermezzo Four: The Language of Analysis, Calculus, and Optimization]()
...
While machines at their core only understand a limited vocabulary of instructions called machine language,
programming language implementors have been a continuous pursuit have been on a continuous pursuit
— from machine languages, to assembly languages, to system languages, and finally to high level languages —
to raise the level of abstraction in which we communicate to them.

In particular, one of the primary languages used in scientific computing (and namely, deep learning) is that of Python
due to the productivity of it's English-like syntax. However, beneath the veneer of pseudocode is
in fact a formal language that is rigid, sharp, and precise, in which programs must be specified mechanically.

On the other hand with natural languages — which is the long standing goal of machines to understand and produce —
are fundamentally flexible, fuzzy, and imprecise, which can is great for quick, fast, and loose communication.
The central question for this book, is *How can we build machines that can understand and produce the latter?*,
which was actually posed all the way back by Alan Turing in his paper
...
Although the artificial neuron — the modelling of a neuron as a weighted sum and threshold function — was invented by Warren McCulloch and Walter Pitts
in [A Logical Calculus of the Ideas Immanent in Nervous Activity (1943)](),
studied by Marvin Minsky in his PhD thesis [Theory of Neural-Analog Reinforcement Systems and Its Application to the Brain Model Problem (1954)]()
(both before Turing proposed his test) and followed up by Frank Rosenblatt's composition of such neurons within a single layer neural network in
[The Perceptron — A Perceiving and Recognizing Automaton (1973)](),
...
and is now referred to (in a somewhat derogatory manner) <span class="defnote">**GOFAI**</span>**good old fashioned AI**.
...
and the more correct approach is to go straight to the source (so to speak) by replicating the human ability to aquire **knowledge** through **reasoning**.
...
As what tends to happen, the dichotomy is moreso a fuzzy spectrum, and their relationship is closer to fighting siblings or rivals
borrowing ideas from one another. A similar tension that you may be familiar with is that of functional programming "vs" object oriented programming,
and one tension that we will explore especially in this first part of the book is 
the <span class="defnote">**continuous**</span>**continuously non-constructive**
vs <span class="defnote">**discrete**</span>**discretely constructive** perspectives in mathematics.
...
also known as <span class="defnote">**software 2.0**</span>**software 2.0** solves with neural networks, and the brain child of such tradition is none other than **ChatGPT**.
...
#### Symbolic Species: Wordnet, ConceptNet, and CYC
...
### 1.2 Intermezzo One: The Language of Set Theory and Logic
<small>[$\hookleftarrow$ Table of Contents](#i-elements-of-networks-1)</small>
...
### 1.5 Random Variables and their Distributions, Expectations, and Variance
<small>[$\hookleftarrow$ Table of Contents](#i-elements-of-networks-1)</small>

### 1.6 Analytical Probabilities from Data by Counting
```python
