...
- [0. From Logical Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.4 General Common Sense with Ontological and Inference Engineering of `CYC`](#04-general-common-sense-with-ontological-and-inference-engineering-of-cyc)
...
### 0.4 General Common Sense with Ontological and Inference Engineering of `CYC`
...
models of problem solving and human cognition; William Kahan (1989) for fundamental
contributions to numerical analysis, most consequentially the IEEE 754 floating-point standard
that made reliable numerical computation reproducible across hardware; Ed Feigenbaum and
Raj Reddy (1994) for developing expert systems that encode human knowledge to solve
...
focusing on statistical (you can see jurafsky moves to appendix)
