...
is to formalize our intuitions around the notions of uncertainty, chance, and likelihood. We will do so with the language of
...
More formally, the theory models <span class="defnote">**uncertainty**</span>**uncertainty** in an <span class="defnote">**experiment**</span>**experiment** with two sets and a function.
...
Finally, the function is the <span class="defnote">**probability law $\mathbb{P}$**</span>**probability law** with type $\mathbb{P}: \mathcal{F} \to \reals$:
...
### 1.2 From Variables to Random Variables
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
