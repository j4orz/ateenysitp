...
- [1. Syntactic Sequence Learning with n-gram Models](#1-syntactic-sequence-learning-with-n-gram-models)
  ...
  - [1.3 Random Variables and their Distributions]() <!-- Expectations, and Variance -->
  - [1.4 From Evaluating to Recovering Probabilities]() <!-- Statistics -->
  - [1.5 Summary]()
...
model language subtly different. That is, as a *weighted set of strings* with the stochastic uncertainty of <span class="defnote">**probability theory**</span>**probability theory**.
...
### 1.4 Analytical Probabilities from Data by Counting
```python
...
### 1.5 Learning Probabilities from Data by Parameter Estimation
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
