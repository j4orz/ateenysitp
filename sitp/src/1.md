...
> [!IMPORTANT]
> <img class="owl" src="./assets/owl.png" alt="" style="float: left; width: 140px; margin: 0 1em 0.5em 0;"> A probability distribution is a list of numbers between 0 and 1 that sum to 1. Intuitively speaking, a first approximation to probability can be conceptualized *as* array programming. <br style="clear: both;">
