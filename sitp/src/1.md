...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  ...
  - [1.8 Intermezzo Two: The Language of Probability Theory and Statistics](#18-intermezzo-two-the-language-of-probability-theory-and-statistics)
...
- [2. Semi-Automated Semantic Sequence Learning via Linear Models with `teenygrad`]()
  ...
  - [2.2 Intermezzo Three: The Language of Linear Algebra](#22-intermezzo-three-the-language-of-linear-algebra)
  ...
  - [2.5 Predicting Categories by Linearly Modeling Classification](#25-predicting-categories-by-linearly-modeling-classification) <!-- $f: \reals^d \to \N$ -->
  - [2.6 Iteratively Fitting Logistic Regression with Cross Entropy Loss]() <!-- $\mathscr{L(\theta)} := $ -->
  - [2.7 Intermezzo Four: The Language of Analysis, Calculus, and Optimization](#28-intermezzo-four-the-language-of-analysis-calculus-and-optimization)
  - [2.8 Generalized Linear Models: Empirical Risk Minimization is Maximum Likehood Estimation]()
  - [2.9 Intermezzo Five: The Language of Statistical Machine Learning]()
...
language implementors and chip designers have been on a continuous pursuit to raise the level of abstraction that programmers express their ideas at.
...
methods to select actions
1. simple reflex agent
2. model-based reflex agent
3. utility-based agent (bayesians)
4. goal-based (search)

all 4 can be converted into learning-based agent
...
#### The Model-Based Reflexive Agent of SHRDLU
...
#### A Stronger Model-Based Reflexive? Agent of CYC
...
### 1.8 Intermezzo Two: The Language of Probability Theory and Statistics
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
