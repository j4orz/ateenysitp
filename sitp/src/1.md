...
is a basic familiarity with the art of programming, and high school calculus.
...
- [Prelude: The Language of Logic, Sets, and Functions](#prelude-the-language-of-logic-sets-and-functions)
- [1. From Certain to Uncertain Knowledge](#1-from-certain-to-uncertain-knowledge)
...
## Prelude: The Language of Logic, Sets and Functions

>Dependent type theory<span class="sidenote-number"></span><span class="sidenote">*Harper's forward to [The Little Typer (Friedman and Christiansen 2018)](https://thelittletyper.com/)*</span> (...) is a wonderfully beguiling, and astonishingly effective, unification of mathematics and programming. In type theory when you prove a theorem you are writing a program to meet a specification-and you can even run it when you are done! A proof of the fundamental theorem of arithmetic amounts to a program for factoring numbers. And it works the other way as well: every program is a proof that its specification is sensible enough to be implementable. Typе theory is a hacker's paradise.
...
We begin with the latter, namely introducing the mathematical foundations that underlie the stochastic and infintely continuous
needed for programming software 2.0 with the [Lean](https://lean-lang.org/learn/) programming language and proof assistant.
Once we've introduced and formalized the basic mathematical preliminaries with Lean,
we will only formalize concepts in Intermezzo chapters *after* using or implementing such concept
with the [teenygrad](https://github.com/j4orz/ateenysitp/tree/master/teeny) deep learning framework.
with the [Python](https://docs.python.org/3/), [Rust](https://rust-lang.org/learn/)
and [CUDA](https://docs.nvidia.com/cuda/cuda-programming-guide/) [Rust](https://nvlabs.github.io/cuda-oxide/) programming languages.
...
## 1. From Certain to Uncertain Knowledge <!-- $p(X=x)$ from $D=\{x^{(i)}\}_{i=1}^{n}$ -->
