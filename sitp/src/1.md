...
- [0. From Logical Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.2 Syntactic Pattern Matching with ELIZA]()
  - [0.3 Narrow Expertise with DENDRIL]()
  - [0.4 General Common Sense with CYC]()
  - [0.5 The Bitter Lesson: From Tractatus to Investigations]()
  - [0.6 Next Token Prediction As Massively Multi-Task Learning]()
...
there are more books which cover logic intertwined with linguistics.
this is out of scope for sitp.
